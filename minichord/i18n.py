"""Qt translation loading for miniChord."""
...
class TranslationManager:
    ...
    def load(self, language: str | None = None) -> TranslationState:
        """Load miniChord and Qt translators for a requested language."""
...
def install_translations(
    ...
    manager = getattr(app, "_minichord_translation_manager", None)
    if not isinstance(manager, TranslationManager):
        manager = TranslationManager(app)
        setattr(app, "_minichord_translation_manager", manager)
...
def translation_manager(app: QApplication) -> TranslationManager | None:
    """Return the currently installed miniChord translation manager."""
    manager = getattr(app, "_minichord_translation_manager", None)
