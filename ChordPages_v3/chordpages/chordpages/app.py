"""Application bootstrap for ChordPages."""
...
from chordpages.settings import APPLICATION_NAME, ORGANIZATION_NAME, SettingsManager
...
def main(argv: Sequence[str] | None = None) -> int:
    """Start the ChordPages GUI application."""
