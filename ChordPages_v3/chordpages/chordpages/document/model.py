"""Minimal text-based document model for the first ChordPages prototype."""
...
from chordpages.document.layout import ChordProLayout, layout_chordpro_song
from chordpages.document.pagination import PaginatedLayout, paginate_layout
...
class ChordPagesDocument:
    ...
    @classmethod
    def from_mchord(cls, content: str) -> "ChordPagesDocument":
