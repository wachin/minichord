"""Page-based document model abstractions for ChordPages."""
...
from chordpages.document.chordpro import ChordProSong
from chordpages.document.dom import DocumentDom
from chordpages.document.layout import ChordProLayout
from chordpages.document.model import ChordPagesDocument
from chordpages.document.pagination import PaginatedLayout
from chordpages.document.page import DEFAULT_TEXT_LINE_HEIGHT_MM, PageLayout
...
class DocumentModel:
    ...
    def to_document(self) -> ChordPagesDocument:
        """Convert the editing model back to the current storage document."""
        return ChordPagesDocument(
            text=self.body_text,
            title=self.title,
